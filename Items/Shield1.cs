...
public class Shield1 : Equipment
{
    //public override void PutInTheEquipSlot( )
    //{
    //    if(equipType == EquipType.Armor) {
    //        if(equipSlotManager.armorSlot.currentEquipment == null) {
    //            gameManager.hero.armor = this;
    //            equipSlotManager.armorSlot.equipmentUI.sprite = equipmentUI;
    ...
    //            equipSlotManager.weaponSlot.equipmentUI.sprite = equipmentUI;
